...
Class Email_model extends CI_Model{
	...
	// load library email
        ...
        //Konten
        $mail->Subject = 'Registration Success | Email Verification';
        $mail->Body = "<html>
  <head>
                ...
                <td class='wrapper'>
                  <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                    ...
                    <tr>
                      <td>
                        <p>Hai $user,</p>
                        <p>Silahkan klik tombol dibawah ini untuk verifikasi email Anda.</p>
                            ...
                            <tr>
                              <td align='center'>
                                <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                                  <tbody>
                                    <tr>
                                      <td><center> <a href='localhost/nidautama/Login/verify/$verificationCode' target='_blank'>Verifikasi Email</a></center> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
